...
export default function XyzPostModal({modalShow, handleCloseModal, apiURL}) {
    // const [modalShow, setModalShow] = useState(null);

    // const handleShowCreatePost = () => setModalShow('CreatePost');
    // const handleShowUpdatePost = () => setModalShow('UpdatePost');
                ...
                >
                    <Modal.Body className="my-2">
                        <Form 
                            ...
                            onSubmit={modalShow === 'CreatePost' ? handleCreatePost : handleEditPost()}
